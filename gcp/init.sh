...
gcloud iam roles update groupproject --project=distributed-computing-478219 --add-permissions="resourcemanager.projects.get,storage.buckets.list,storage.buckets.create,storage.objects.get,storage.objects.list,storage.objects.create,storage.objects.delete,dataproc.clusters.create,dataproc.clusters.delete,dataproc.clusters.get,dataproc.clusters.update,dataproc.jobs.create,dataproc.jobs.get,dataproc.jobs.list"
